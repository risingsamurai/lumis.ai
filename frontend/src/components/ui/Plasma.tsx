 ...
 * Adapted for fairlens-ai – supports brand color palette.
 */
...
export interface PlasmaProps {
  /** Accent color for the plasma effect. Defaults to #6C47FF (brand-primary). */
  color?: string;
...
const hexToRgb = (hex: string): [number, number, number] => {
  ...
  if (!result) return [0.424, 0.278, 1.0]; // brand-primary fallback
  return [
